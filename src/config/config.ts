const CONFIG =  {
    ...
    RENDER_TREE_UI: false, // This represents whether you would like to render using the TreeUI component
    RENDER_TREE_OUTPUT: true, // This represents whether you would like to render using the TreeOutput component
