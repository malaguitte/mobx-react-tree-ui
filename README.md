...
* Form
    ...
    There was also the need for a new button on this form, so the user could click to parse the file selected above. For that I added a new button with a "`onClick={this.loadAndReadFile}`" call.
